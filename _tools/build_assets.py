...
WORKS = [
    # ——— 校园纪实 · 凤麒喊楼
    ("hanlou-01", s("校园照片", "2026凤麒高三喊楼", "T1Z_3775.JPG"),   "campus", "凤麒喊楼", "高三喊楼 · 人海与微光", None),
    ("hanlou-02", s("校园照片", "2026凤麒高三喊楼", "T1Z_3781.JPG"),   "campus", "凤麒喊楼", "高三喊楼 · 声浪现场", None),
    ("hanlou-03", s("校园照片", "2026凤麒高三喊楼", "T1Z_3885.JPG"),   "campus", "凤麒喊楼", "高三喊楼 · 举起双手", None),
    ("hanlou-04", s("校园照片", "2026凤麒高三喊楼", "T1Z_3891.JPG"),   "campus", "凤麒喊楼", "高三喊楼 · 台上台下", None),
    ("hanlou-05", s("校园照片", "2026凤麒高三喊楼", "T1Z_3881.JPG"),   "campus", "凤麒喊楼", "高三喊楼 · 夜色舞台", None),
    ("hanlou-06", s("校园照片", "2026凤麒高三喊楼", "T1Z_3908.JPG"),   "campus", "凤麒喊楼", "高三喊楼 · 荧光成海", None),
    ("hanlou-07", s("校园照片", "2026凤麒高三喊楼", "T1Z_3911.JPG"),   "campus", "凤麒喊楼", "高三喊楼 · 旗帜飞扬", None),
    ("hanlou-08", s("校园照片", "2026凤麒高三喊楼", "T1Z_4071.JPG"),   "campus", "凤麒喊楼", "高三喊楼 · 最后的合影", None),
    # ——— 校园纪实 · 运动青春
    ("sports-01", s("校园照片", "运动会", "运动会2026.4.30", "T1Z_2124.JPG"), "campus", "运动青春", "4×100 接力 · 交接瞬间", None),
    ("sports-02", s("校园照片", "运动会", "运动会2026.4.30", "T1Z_2259.JPG"), "campus", "运动青春", "百米冲刺 · 年轻的脸", None),
    ("sports-03", s("校园照片", "运动会", "运动会2026.4.30", "T1Z_2393.JPG"), "campus", "运动青春", "跳高 · 越过横杆", None),
    ("sports-04", s("校园照片", "运动会", "运动会2026.4.30", "T1Z_2430.JPG"), "campus", "运动青春", "径赛 · 全力奔跑", None),
    ("sports-05", s("校园照片", "运动会", "运动会2026.4.30", "T1Z_2595.JPG"), "campus", "运动青春", "田径场上", None),
    ("sports-06", s("校园照片", "运动会", "运动会2026.4.30", "T1Z_2681.JPG"), "campus", "运动青春", "终点计时", None),
    ("sports-07", s("校园照片", "运动会", "运动会2026.4.30", "T1Z_3640.JPG"), "campus", "运动青春", "颁奖时刻", None),
    ("sports-08", s("校园照片", "运动会", "运动会2026.4.30", "T1Z_3647.JPG"), "campus", "运动青春", "领奖台上", None),
    ...
    ("view-12", s("下载", "18.JPG"),                                              "campus", "校园四季", "教学楼与雕塑", None),
    # ——— 校外采风 · 玉武三江
    ("sanjiang-01", s("校外活动", "玉武三江研学", "IMG_20260328_120436_0_2026-08-19_12-03-07_939.jpg"),   "field", "玉武三江", "侗寨风雨桥", "竖"),
    ("sanjiang-02", s("校外活动", "玉武三江研学", "IMG_20260328_121233_1_2026-08-19_12-03-07_972.jpg"),   "field", "玉武三江", "寨中巷道", "竖"),
    ("sanjiang-03", s("校外活动", "玉武三江研学", "IMG_20260328_121420_2_2026-08-19_12-03-07_997.jpg"),   "field", "玉武三江", "市集红蛋", None),
    ("sanjiang-04", s("校外活动", "玉武三江研学", "IMG_20260329_100244_3_2026-08-19_12-03-08_021.jpg"),   "field", "玉武三江", "远山云雾", None),
    ("sanjiang-05", s("校外活动", "玉武三江研学", "IMG_20260329_101507_4_2026-08-19_12-03-08_047.jpg"),   "field", "玉武三江", "红竹笼", None),
    ("sanjiang-06", s("校外活动", "玉武三江研学", "IMG_20260329_111831_5_2026-08-19_12-03-08_066.jpg"),   "field", "玉武三江", "春白花", "竖"),
    ("sanjiang-07", s("校外活动", "玉武三江研学", "IMG_9633.JPG"),  "field", "玉武三江", "寨中石板路", None),
    ("sanjiang-08", s("校外活动", "玉武三江研学", "IMG_9655.JPG"),  "field", "玉武三江", "采茶的少年", None),
    ("sanjiang-09", s("校外活动", "玉武三江研学", "IMG_9659.JPG"),  "field", "玉武三江", "茶园孤树", None),
    ("sanjiang-10", s("校外活动", "玉武三江研学", "IMG_9665.JPG"),  "field", "玉武三江", "梯田茶园", "竖"),
    ("sanjiang-11", s("校外活动", "玉武三江研学", "IMG_9793.JPG"),  "field", "玉武三江", "雨后村寨", None),
    ("sanjiang-12", s("校外活动", "玉武三江研学", "IMG_9818.JPG"),  "field", "玉武三江", "远山积翠", "竖"),
    ("sanjiang-13", s("校外活动", "玉武三江研学", "IMG_9822.JPG"),  "field", "玉武三江", "云雾木楼", "竖"),
    ("sanjiang-14", s("校外活动", "玉武三江研学", "IMG_9850.JPG"),  "field", "玉武三江", "吊脚楼人家", None),
    ("sanjiang-15", s("校外活动", "玉武三江研学", "IMG_9853.JPG"),  "field", "玉武三江", "寨角", "竖"),
    ("sanjiang-16", s("校外活动", "玉武三江研学", "IMG_9856.JPG"),  "field", "玉武三江", "风雨桥下", "竖"),
    ("sanjiang-17", s("校外活动", "玉武三江研学", "IMG_9882.JPG"),  "field", "玉武三江", "苗家阿婆", None),
...
HEROES = [
    ...
    ("hero-night",   s("校园照片", "2026凤麒高三喊楼", "T1Z_3906.JPG"),            2000),
    ("hero-city",    s("下载", "13.jpg"),                                        2000),
    ("hero-blossom", s("校园照片", "校园风光", "A8B56A0523E56FEB0EC5384AD7A6DBF5.jpg"), 1600),
    ("hero-sports",  s("校园照片", "运动会", "运动会2026.4.30", "T1Z_2259.JPG"),    1800),
    ("hero-field",   s("校外活动", "玉武三江研学", "IMG_20260329_100244_3_2026-08-19_12-03-08_021.jpg"), 1800),
